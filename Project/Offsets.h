...
struct offsets
{
	...
	DWORD dwEntityList = 0x4DDB92C;
	DWORD dwForceAttack = 0x320BE10;
	DWORD dwForceAttack2 = 0x320BE1C;
	DWORD dwForceBackward = 0x320BE64;
	DWORD dwForceForward = 0x320BE58;
	DWORD dwForceJump = 0x52858A8;
	DWORD dwForceLeft = 0x320BE70;
	DWORD dwForceRight = 0x320BE7C;
	DWORD dwGameDir = 0x62B900;
	DWORD dwGameRulesProxy = 0x52F90CC;
	DWORD dwGetAllClasses = 0xDE9CAC;
	DWORD dwGlobalVars = 0x58CCE0;
	DWORD dwGlowObjectManager = 0x5324588;
	DWORD dwInput = 0x522CF00;
	DWORD dwInterfaceLinkList = 0x96E944;
	DWORD dwLocalPlayer = 0xDBF4CC;
	DWORD dwMouseEnable = 0xDC51D8;
	DWORD dwMouseEnablePtr = 0xDC51A8;
	DWORD dwPlayerResource = 0x320A190;
	DWORD dwRadarBase = 0x52106A4;
	DWORD dwSensitivity = 0xDC5074;
	DWORD dwSensitivityPtr = 0xDC5048;
	DWORD dwSetClanTag = 0x8A410;
	DWORD dwViewMatrix = 0x4DCD244;
	DWORD dwWeaponTable = 0x522D9C4;
	DWORD dwWeaponTableIndex = 0x326C;
	DWORD dwYawPtr = 0xDC4E38;
	...
	DWORD m_pitchClassPtr = 0x5210940;
	DWORD m_yawClassPtr = 0xDC4E38;
