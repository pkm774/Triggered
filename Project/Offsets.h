...
struct offsets
{
	...
	DWORD find_hud_element = 0x281D5A80;
	DWORD force_update_spectator_glow = 0x3BE35A;
	DWORD interface_engine_cvar = 0x3EA3C;
	DWORD is_c4_owner = 0x3CB3D0;
