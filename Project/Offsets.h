...
struct offsets
{
	...
	DWORD dwEntityList = 0x4DD7AEC;
	DWORD dwForceAttack = 0x3207FE8;
	DWORD dwForceAttack2 = 0x3207FF4;
	DWORD dwForceBackward = 0x3208030;
	DWORD dwForceForward = 0x3208024;
	DWORD dwForceJump = 0x5281A34;
	DWORD dwForceLeft = 0x3207FA0;
	DWORD dwForceRight = 0x3207FAC;
	DWORD dwGameDir = 0x62A900;
	DWORD dwGameRulesProxy = 0x52F525C;
	DWORD dwGetAllClasses = 0xDE5DAC;
	DWORD dwGlobalVars = 0x58BCE0;
	DWORD dwGlowObjectManager = 0x53206F8;
	DWORD dwInput = 0x52290C0;
	DWORD dwInterfaceLinkList = 0x96C044;
	DWORD dwLocalPlayer = 0xDBB5CC;
	DWORD dwMouseEnable = 0xDC12D8;
	DWORD dwMouseEnablePtr = 0xDC12A8;
	DWORD dwPlayerResource = 0x3206350;
	DWORD dwRadarBase = 0x520C864;
	DWORD dwSensitivity = 0xDC1174;
	DWORD dwSensitivityPtr = 0xDC1148;
	DWORD dwSetClanTag = 0x8A320;
	DWORD dwViewMatrix = 0x4DC9404;
	DWORD dwWeaponTable = 0x5229B84;
	DWORD dwWeaponTableIndex = 0x326C;
	DWORD dwYawPtr = 0xDC0F38;
	DWORD dwZoomSensitivityRatioPtr = 0xDC7720;
	DWORD dwbSendPackets = 0xD82C2;
	DWORD dwppDirect3DDevice9 = 0xA5050;
	DWORD find_hud_element = 0x353B55B0;
	...
	DWORD m_pitchClassPtr = 0x520CB00;
